...
ggplot(cleaned_simulated_data, aes(x = time_period, y = marriages_licenses, fill = civic_centre)) +
  ...
  labs(title = "Barplot of Marriages Licenses by Time Period",
       x = "Time Period",
